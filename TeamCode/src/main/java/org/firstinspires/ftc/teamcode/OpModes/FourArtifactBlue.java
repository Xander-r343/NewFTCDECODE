...
@Autonomous(name = "4 artifact Blue")
public class FourArtifactBlue extends LinearOpMode {
    Servo rgb;
        ...
        while (opModeIsActive()) {
            switch (AutoState) {
                ...
                case 4: {
                    timer.reset();
                    timer.startTime();
                    pods.holdPosition(34, 84,90,0.5);
                    pods.update();
