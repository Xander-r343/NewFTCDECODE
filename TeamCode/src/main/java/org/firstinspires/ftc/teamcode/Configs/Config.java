...
//
    ...
    public final double timePerDegInSeconds =0.9;
    //flicker servo time same thing
    public final double timeForFlickInSeconds = 0.25;
    ...
    public static final double slot0FiringPosition = 0.05;
    public static final double slot1FiringPosition = 0.43;
    public static final double slot2FiringPosition = 0.8;

    public static final double slot0Pickup = 0.60;
    public static final double slot1Pickup = 1;
    public static final double slot2Pickup = 0.2;
    //degrees
